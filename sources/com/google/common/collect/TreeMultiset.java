...
public final class TreeMultiset<E> extends AbstractSortedMultiset<E> implements Serializable {
    ...
    public AvlNode<E> firstNode() {
        ...
        if (this.range.hasLowerBound()) {
            ...
            AvlNode<E> access$1000 = this.rootReference.get().ceiling(comparator(), lowerEndpoint);
            if (access$1000 == null) {
                return null;
            }
    ...
    public AvlNode<E> lastNode() {
        ...
        if (this.range.hasUpperBound()) {
            ...
            AvlNode<E> access$1100 = this.rootReference.get().floor(comparator(), upperEndpoint);
            if (access$1100 == null) {
                return null;
            }
