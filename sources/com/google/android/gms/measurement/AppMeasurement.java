...
public class AppMeasurement {
    ...
    public static class ConditionalUserProperty {
        ...
        private ConditionalUserProperty(@NonNull Bundle bundle) {
            ...
            this.mName = (String) zzgk.zza(bundle, AppMeasurementSdk.ConditionalUserProperty.NAME, String.class, null);
            this.mValue = zzgk.zza(bundle, "value", Object.class, null);
            this.mTriggerEventName = (String) zzgk.zza(bundle, AppMeasurementSdk.ConditionalUserProperty.TRIGGER_EVENT_NAME, String.class, null);
            this.mTriggerTimeout = ((Long) zzgk.zza(bundle, AppMeasurementSdk.ConditionalUserProperty.TRIGGER_TIMEOUT, Long.class, 0L)).longValue();
            this.mTimedOutEventName = (String) zzgk.zza(bundle, AppMeasurementSdk.ConditionalUserProperty.TIMED_OUT_EVENT_NAME, String.class, null);
            this.mTimedOutEventParams = (Bundle) zzgk.zza(bundle, AppMeasurementSdk.ConditionalUserProperty.TIMED_OUT_EVENT_PARAMS, Bundle.class, null);
            this.mTriggeredEventName = (String) zzgk.zza(bundle, AppMeasurementSdk.ConditionalUserProperty.TRIGGERED_EVENT_NAME, String.class, null);
            this.mTriggeredEventParams = (Bundle) zzgk.zza(bundle, AppMeasurementSdk.ConditionalUserProperty.TRIGGERED_EVENT_PARAMS, Bundle.class, null);
            this.mTimeToLive = ((Long) zzgk.zza(bundle, AppMeasurementSdk.ConditionalUserProperty.TIME_TO_LIVE, Long.class, 0L)).longValue();
            this.mExpiredEventName = (String) zzgk.zza(bundle, AppMeasurementSdk.ConditionalUserProperty.EXPIRED_EVENT_NAME, String.class, null);
            this.mExpiredEventParams = (Bundle) zzgk.zza(bundle, AppMeasurementSdk.ConditionalUserProperty.EXPIRED_EVENT_PARAMS, Bundle.class, null);
        }
    ...
    private static AppMeasurement zza(Context context, String str, String str2) {
        if (zza == null) {
            synchronized (AppMeasurement.class) {
                if (zza == null) {
                    zzhp zzb2 = zzb(context, (Bundle) null);
                    if (zzb2 != null) {
                        zza = new AppMeasurement(zzb2);
                    } else {
                        zza = new AppMeasurement(zzfn.zza(context, (String) null, (String) null, (Bundle) null));
                    }
                }
            }
        }
            ...
            synchronized (AppMeasurement.class) {
                if (zza == null) {
                    ...
                    if (zzb2 != null) {
                        ...
                        zza = new AppMeasurement(zzfn.zza(context, (String) null, (String) null, bundle));
                    }
                }
            }
        }
