...
public class WebpUtil {
    ...
    private static Pair<Integer, Integer> getVP8LDimension(InputStream inputStream) throws IOException {
        ...
        byte read2 = ((byte) inputStream.read()) & UnsignedBytes.MAX_VALUE;
        return new Pair<>(Integer.valueOf((read | ((read2 & 63) << 8)) + 1), Integer.valueOf(((((((byte) inputStream.read()) & UnsignedBytes.MAX_VALUE) & Ascii.SI) << 10) | ((((byte) inputStream.read()) & UnsignedBytes.MAX_VALUE) << 2) | ((read2 & 192) >> 6)) + 1));
    }
