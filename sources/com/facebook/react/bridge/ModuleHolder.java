...
public class ModuleHolder {
    ...
    private NativeModule create() {
        ...
        SystraceMessage.beginSection(0, "ModuleHolder.createModule").arg(AppMeasurementSdk.ConditionalUserProperty.NAME, (Object) this.mName).flush();
        PrinterHolder.getPrinter().logMessage(ReactDebugOverlayTags.NATIVE_MODULE, "NativeModule init: %s", this.mName);
        try {
    ...
    private void doInitialize(NativeModule nativeModule) {
        boolean z;
        SystraceMessage.beginSection(0, "ModuleHolder.initialize").arg(AppMeasurementSdk.ConditionalUserProperty.NAME, (Object) this.mName).flush();
