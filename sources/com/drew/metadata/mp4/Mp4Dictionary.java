...
public class Mp4Dictionary {
    ...
    public static String lookup(int i, String str) {
        return (!_dictionary.containsKey(Integer.valueOf(i)) || !_dictionary.get(Integer.valueOf(i)).containsKey(str)) ? "Unknown" : (String) _dictionary.get(Integer.valueOf(i)).get(str);
    }
